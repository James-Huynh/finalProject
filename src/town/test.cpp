...
//    double weakenDmgProbability);
    ...
    Sword ironSword("iron sword","level 2 with 20% pierce through armor",500,2,500,0.2);
    Sword brassSword("brass sword","level 3 with 40% pierce through armor",1000,3,1500,0.4);
    Sword woodSword("wood sword","level 1 with 5% pierce through armor",100,1,100,0.05);
    ...
    Shield ironShield("iron ax","level 2 with 20% pierce through armor",500,2,500,0.2);
    Shield brassShield("brass ax","level 3 with 40% pierce through armor",300,3,200,0.1);
    Shield woodShield("wood ax","level 1 with 5% pierce through armor",100,1,50,0.05);
